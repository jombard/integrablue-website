  ...
  <div class="min-h-screen bg-white">
    ...
    <footer class="bg-gray-900 text-white py-16">
      <div class="ui-container mx-auto px-4">
        <div class="grid md:grid-cols-4 gap-8">
          <div class="md:col-span-2">
            ...
            <p class="text-gray-300 mb-6 max-w-md">
              Modern web solutions for small businesses and startups. We build
              fast, beautiful, and scalable websites that help you succeed
              online.
            </p>
        ...
        >
          <p>
            &copy; 2025 IntegraBlue Web Agency Limited. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
...
useHead({
  title: "IntegraBlue Web Agency - Modern Web Solutions for Small Businesses",
  meta: [
    {
      name: "description",
      content:
        "IntegraBlue Web Agency specializes in modern web design and development for small businesses and startups. Built with Nuxt 3 and Vue.js.",
    },
  ],
});
</script>
